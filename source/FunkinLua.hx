...
class FunkinLua {
	...
	public function new(script:String) {
		...
		// I'm allowing Require and OS because Jadyn might want to do cool shit
		//set('require', false);
		...
		set('ratingName', '');
		set('ratingFC', '');
		set('version', MainMenuState.vsTescoVersion.trim());
		...
		set('photoSensitive', ClientPrefs.photoSensitive);
